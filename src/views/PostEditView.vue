        ...
        <section class="section">
            ...
            <form @submit.prevent="updatePost">
                ...
                <div class="input_container">
                    ...
                    <textarea v-model="editedPost.content" name="content" id="content" cols="30" rows="10"></textarea>
                </div>
...
export default {
    ...
    methods: {
        ...
        async updatePost() {
            try {
                await axios.put(`http://localhost:3000/posts/${this.editedPost.id}`, this.editedPost);
